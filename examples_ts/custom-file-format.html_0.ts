...
const config = {
    ...
    tracks: [
        ...
        {
            name: 'ILMN Dragen ROH',
            url: './Example.dragen.roh.bed',
            color: '#03A9F4',
            type: 'annotation',
            format: 'dragenrohbed',
        }
...
const browser = await igv.createBrowser((document.getElementById("igvDiv") as HTMLElement), config)
