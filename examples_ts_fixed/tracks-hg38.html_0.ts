...
igv.createBrowser(igvDiv, options)
    .then(function (browser) {
        ...
        (document.getElementById("sessionButton") as HTMLElement).addEventListener("click", () => {
            try {
        ...
        (document.getElementById("bookmarkButton") as HTMLElement).addEventListener("click",
            () => (window as any).history.pushState({}, "IGV", browser.sessionURL()));

        (document.getElementById("svgButton") as HTMLElement).addEventListener("click", () => {
