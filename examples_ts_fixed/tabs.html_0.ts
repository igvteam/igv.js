...
function initIGV() {
    ...
    var igvDiv, options
    igvDiv = (document.getElementById("igvDiv") as HTMLElement)
    options =
        {
            locus: "AQP4",
            genome: "hg19",
...
function initTabs() {
    ...
    var liItems = Array.from((document.getElementById('tabs') as HTMLElement).childNodes).filter(function (item) {
    ...
    tabLinks.forEach(function (tabLink) {
        ...
        var contentDiv = (document.getElementById(id) as HTMLElement)
        tabs.push({
            id: id,
            link: tabLink,
            content: contentDiv
