...
***[Alignments](https://igv.org/web/release/2.11.1/examples/cram-vcf.html)***

***[Interactions](https://igv.org/web/release/2.11.1/examples/interact.html)***

***[Copy number](https://igv.org/web/release/2.11.1/examples/copyNumber.html)***

***[Multiple regions](https://igv.org/web/release/2.11.1/examples/multi-locus.html)***

***[Mutation Annotation Format (MAF)](https://igv.org/web/release/2.11.1/examples/maf-tcga.html)***

***[Variant color options](https://igv.org/web/release/2.11.1/examples/variant-colors.html)***

***[More](https://igv.org/web/release/2.11.1/examples/)***
...
can be downloaded from [https://cdn.jsdelivr.net/npm/igv@2.11.1/dist/](https://cdn.jsdelivr.net/npm/igv@2.11.1/dist/). 

To import igv as an ES6 module

```javascript
import igv from "https://cdn.jsdelivr.net/npm/igv@2.11.1/dist/igv.esm.min.js"
``` 

Or as a script include (defines the "igv" global)

```html
<script src="https://cdn.jsdelivr.net/npm/igv@2.11.1/dist/igv.min.js"></script>
```   
