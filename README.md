...
***[Alignments](https://igv.org/web/release/2.9.0/examples/cram-vcf.html)***

***[Interactions](https://igv.org/web/release/2.9.0/examples/arcs.html)***

***[Copy number](https://igv.org/web/release/2.9.0/examples/copyNumber.html)***

***[Multiple regions](https://igv.org/web/release/2.9.0/examples/multi-locus.html)***

***[Mutation Annotation Format (MAF)](https://igv.org/web/release/2.9.0/examples/maf-tcga.html)***

***[More](https://igv.org/web/release/2.9.0/examples/)***
...
```html
<script src="https://cdn.jsdelivr.net/npm/igv@2.9.0/dist/igv.min.js"></script>
``` 

Pre-built files for ES5 (igv.min.js) and ES6 (igv.esm.min.js)
can be downloaded from [https://cdn.jsdelivr.net/npm/igv@2.9.0/dist/](https://cdn.jsdelivr.net/npm/igv@2.9.0/dist/).   
