...
can be downloaded from [https://cdn.jsdelivr.net/npm/igv@3.0.1/dist/](https://cdn.jsdelivr.net/npm/igv@3.0.1/dist/). 

To import igv as an ES6 module

```javascript
import igv from "https://cdn.jsdelivr.net/npm/igv@3.0.1/dist/igv.esm.min.js"
``` 
