...
```html
<script src="https://cdn.jsdelivr.net/npm/igv@2.3.2/dist/igv.min.js"></script>
``` 

Pre-built files for ES5 (igv.min.js) and ES6 (igv.esm.min.js)
can be downloaded from [https://cdn.jsdelivr.net/npm/igv@2.3.2/dist/](https://cdn.jsdelivr.net/npm/igv@2.3.2/dist/).   
