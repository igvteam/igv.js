...
***[Alignments](https://igv.org/web/release/2.13.3/examples/cram-vcf.html)***

***[Interactions](https://igv.org/web/release/2.13.3/examples/interact.html)***

***[Copy number](https://igv.org/web/release/2.13.3/examples/copyNumber.html)***

***[Multiple regions](https://igv.org/web/release/2.13.3/examples/multi-locus.html)***

***[Mutation Annotation Format (MAF)](https://igv.org/web/release/2.13.3/examples/maf-tcga.html)***

***[Variant color options](https://igv.org/web/release/2.13.3/examples/variant-colors.html)***

***[More](https://igv.org/web/release/2.13.3/examples/)***
...
can be downloaded from [https://cdn.jsdelivr.net/npm/igv@2.13.3/dist/](https://cdn.jsdelivr.net/npm/igv@2.13.3/dist/). 
