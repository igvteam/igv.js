...
***[Alignments](https://igv.org/web/release/2.2.8/examples/cram.html)***

***[Copy number](https://igv.org/web/release/2.2.8/examples/copyNumber.html)***

***[Multiple regions](https://igv.org/web/release/2.2.8/examples/multi-locus.html)***

***[More](https://igv.org/web/release/2.2.8/examples/)***
...
```html
<script src="https://cdn.jsdelivr.net/npm/igv@2.2.8/dist/igv.min.js"></script>
``` 

Pre-built files for ES5 (igv.min.js) and ES6 (igv.esm.min.js)
can be downloaded from [https://cdn.jsdelivr.net/npm/igv@2.2.8/dist/](https://cdn.jsdelivr.net/npm/igv@2.2.8/dist/).   
...
```requirejs(['igv.min'], function (igv) {...}```   *(see [examples/igv-require.html](https://cdn.jsdelivr.net/npm/igv@2.2.8/examples/igv-require.html))*

***or*** import it as an es6 module 

```import igv from 'igv.esm.min.js'```  *(see [examples/igv-esm.html](https://cdn.jsdelivr.net/npm/igv@2.2.8/examples/igv-esm.html))*
