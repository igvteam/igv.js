...
can be downloaded from [https://cdn.jsdelivr.net/npm/igv@2.13.5/dist/](https://cdn.jsdelivr.net/npm/igv@2.13.5/dist/). 
...
```html
<script src="https://cdn.jsdelivr.net/npm/igv@2.13.5/dist/igv.min.js"></script>
```   
