...
***[Alignments](https://igv.org/web/release/3.8.7/examples/cram-vcf.html)***

***[Interactions](https://igv.org/web/release/3.8.7/examples/interact.html)***

***[Copy number](https://igv.org/web/release/3.8.7/examples/copyNumber.html)***

***[Multiple regions](https://igv.org/web/release/3.8.7/examples/multi-locus.html)***

***[Mutation Annotation Format (MAF)](https://igv.org/web/release/3.8.7/examples/maf-tcga.html)***

***[Variant color options](https://igv.org/web/release/3.8.7/examples/variant-colors.html)***

***[More](https://igv.org/web/release/3.8.7/examples/)***
...
can be downloaded from [https://cdn.jsdelivr.net/npm/igv@3.8.7/dist/](https://cdn.jsdelivr.net/npm/igv@3.8.7/dist/). 

To import igv as an ES6 module

```javascript
import igv from "https://cdn.jsdelivr.net/npm/igv@3.8.7/dist/igv.esm.min.js"
``` 

Or as a script include (defines the "igv" global)

```html
<script src="https://cdn.jsdelivr.net/npm/igv@3.8.7/dist/igv.min.js"></script>
```   
