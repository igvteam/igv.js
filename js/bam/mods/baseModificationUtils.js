...
function valueString(modification, likelihood) {
    const l = byteToUnsignedInt(likelihood)
    return "Base modification: " + ((codeValues.has(modification)) ? codeValues.get(modification) : "Uknown")// + " (" + l + "%)"
}
...
export {valueString, isChEBI, getBaseModificationSets, byteToUnsignedInt}
